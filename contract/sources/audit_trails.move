...
public struct ProductEntryLogged has copy, drop, store {
    issuer_role: Role,
...
public entry fun new_product(
    ...
    let trusted_properties = build_trusted_properties(
        string::utf8(b"role"),
        string::utf8(b"manufacturer"),
    );
    ...
    transfer::share_object(Product {
        ...
        image_url,
        bill_of_materials: vec_map_from_keys_values<String, String>(
...
public entry fun log_entry_data(
    ...
    transfer::transfer(
        ProductEntry {
            ...
            entry_data: vec_map_from_keys_values<String, String>(
                entry_data_keys,
                entry_data_values,
            ),
            timestamp: clock::timestamp_ms(clock),
...
fun build_trusted_properties(
    property_name_str: String,
    property_value_str: String,
): VecMap<TrustedPropertyName, TrustedPropertyValue> {
    ...
    vec_map_from_keys_values<TrustedPropertyName, TrustedPropertyValue>(
        property_name_vec,
        property_value_vec,
    )
}
