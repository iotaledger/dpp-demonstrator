...
const ActionButtons: React.FC<ActionButtonsProps> = ({
  ...
  const getButtonClasses = (variant: string = 'primary') => {
    switch (variant) {
      ...
      case 'primary':
      default:
        return 'w-full bg-blue-600 text-white hover:bg-blue-700 px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-102';
    }
  };
