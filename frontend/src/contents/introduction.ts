    ...
    players: [
      {
        ...
        description: t(
          'Design and produce goods, adding material, sustainability, and compliance data to the DPP.',
        ),
      },
      {
        title: t('Distributors'),
        description: t(
          'Handle product logistics and market delivery, updating the DPP with tracking, certification, and transport data.',
        ),
      },
      {
        title: t('Consumers'),
        description: t(
          'Purchase and use products, consulting the DPP for origin, sustainability, and repair options.',
        ),
      },
      {
        title: t('Service Providers'),
        description: t(
          'Offer repair, maintenance, and upgrades, relying on the DPP for product history and part details.',
        ),
      },
      {
        title: t('Recyclers'),
        description: t(
          'Process end-of-life products, using the DPP to identify materials and improve recovery.',
        ),
      },
      {
        title: t('Extended Producer Responsibility Organizations (EPRO)'),
        description: t(
          'Support manufacturers in end-of-life obligations and oversee recycling & compliance.',
        ),
      },
    ],
  },
...
export const INTRO_SLIDE_7 = {
  ...
  content: {
    ...
    description: t(
      'introSlide7.description',
      'Lifecycle data is fragmented and rarely shared, making it hard to track. To solve this, each DPP can be pre-funded with Lifecycle Credits (LCCs), tokens that reward verified data contributions and are redeemable for real-world value.',
    ),
    steps: [
      t(
  ...
  content: {
    ...
    walletOptions: [
      ...
      },
      {
        ...
        title: t('Mobile'),
        installText: t(
          'Install Nightly Wallet ({COMPONENT} | {COMPONENT}) and connect when prompted.',
        ),
        iosText: 'iOS',
    ...
    notice: {
      text: t(
        'Both wallets enable secure interaction with this demo without requiring any token balance.',
      ),
    },
  },
};
...
export const INTRO_SLIDE_12 = {
  ...
  content: {
    ...
    description: t(
      'introSlide12.description',
      'Click to start the guided demo as a Service Technician!',
    ),
    buttons: {
      desktop: {
        text: t('Start Tour'),
